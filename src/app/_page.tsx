    ...
    <>
      <div className="tmrwdao-grid z-0">
        <div className="col-12 box-border">
          <section className="relative">
            ...
            <LongArrowIcon className="w-[22px] h-[22px] lg:w-[34px] lg:h-[34px] xl:w-[42px] xl:h-[42px] absolute bottom-0 lg:bottom-[33px] xl:bottom-[41px] left-1/2 translate-x-[-50%] animate-up-down" />
          </section>
          ...
          <section className="py-[56px] md:py-[55px] lg:py-[24px] xl:py-[30px]">
            <div className="flex flex-row items-center gap-[20px] w-full overflow-x-auto lg:overflow-hidden lg:flex-wrap">
              <div className="relative overflow-hidden group flex flex-col items-start justify-end w-full h-[246px] lg:h-[251px] xl:h-[314px] shrink-0 py-[14px] px-[22px] bg-darkGray rounded-[15px] box-border transition-all duration-300 xs:w-[335px] lg:flex-row lg:items-end lg:justify-start lg:w-full hover:bg-mainColor">
                <p className="absolute top-[30px] left-[26px] xl:left-[33px] xl:top-[37px] m-0 text-[12px] font-Unbounded font-light text-white xl:text-[15px] transition-[opacity] duration-300 lg:opacity-100 lg:group-hover:opacity-0">
                  01
                </p>
          ...
          <section className="py-[60px] lg:py-[67px] xl:py-[84px]">
            <div className="flex flex-col gap-[20px] md:gap-[25px] md:flex-row bg-mainColor py-[21px] px-[22px] rounded-[12px] xl:p-[32px] md:items-stretch">
              ...
              <div className="w-full md:flex-1">
                <img
                  className="w-full h-[270px] object-cover object-center rounded-[12px] md:h-[265] lg:h-[278.58px] xl:h-[348.22px] align-top"
      ...
      <div className="bg-mainColor pt-[60px] pb-[55px] lg:py-[100.8px] xl:py-[126px]">
        <div className="tmrwdao-grid">
          ...
          <div className="col-12 box-border">
            <div className="flex flex-row gap-[20px] overflow-x-auto py-[36px] md:py-[33px] lg:py-[40px] xl:py-[50px] lg:overflow-x-hidden mr-[-1.25rem]">
        ...
        {posts.map(({ title, description, img, date }, index) => (
          <div className="col-12 md:col-6 lg:col-4" key={index}>
            <div className="flex flex-col">
              <img
                className="w-[100%] h-[335px] object-fill object-center rounded-[12px] mb-[15px] lg:mb-[12.8px] xl:mb-[16px] md:h-[341px] lg:h-[288px] xl:h-[203px]"
                src={img}
                alt=""
              />
